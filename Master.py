...
start_button = button.Button(screen_width * 0.33 - playbutton_width // 2, screen_height * 0.3, start_img, 1)
quit_button = button.Button(screen_width * 0.66 - quitbutton_width // 2, screen_height * 0.3, quit_img, 1)
...
while run:
    ...
    if game_menu == True:
        name_text_rect = name_text.get_rect(center=(screen_width // 2, screen_height // 7))
